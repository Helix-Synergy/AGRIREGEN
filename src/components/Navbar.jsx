...
const Navbar = () => {
  ...
  const nav_links = [
    { name: "Home", link: "/" },
    { name: "About", link: "/about-Agrigegen-conclave" },
    { name: "Executive Panel", link: "/executive-panel-members/" },
    { name: "Tracks", link: "/Agrigegen-conference-tracks/" },
    { name: "Orators", link: "/Agrigegen-orators" },
    { name: "Schedule", link: "/Agrigegen-event-schedule" },
            ...
            style={{
              ...
              padding:
                isOpen && window.innerWidth < 1024
                  ...
                  : scrolled
                    ? "0px"
                    : "6px", // Increased padding from 4px to 6px to give the logo room inside the border
              objectPosition: "center", // Keeps it centered inside the circle
            }}
          />
        </div>
