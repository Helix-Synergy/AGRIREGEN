  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/Agrigegen-orators" element={<Orators />} />
        <Route path="/about-Agrigegen-conclave"element={<AboutOralMed />} />
        <Route path="/Agrigegen-event-schedule"element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/Agrigegen-conference-tracks/" element={<RotatingLogos />} />
